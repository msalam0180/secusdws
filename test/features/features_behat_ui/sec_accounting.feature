...
Scenario: Accounting and Auditing Pages Screenshot
  Given "rulemaking_index" terms:
    ...
    And "release" content:
      ...
      | Administrative Proceeding1 | Administrative Proceedings | AAER-12345, 34-12346 | Allen             | this is Allen detail    | published        | 2021-02-02 12:00:00 | 1      | Note1                 | Behat External, Behat Internal | Comment behat         |                         |                                     | ui-98-po, ab-12-cd        |                                  |
      | Administrative Proceeding2 | Administrative Proceedings | AAER-34567           | Caroline          | this is Caroline detail | published        | 2021-05-03 12:00:00 | 1      |                       |                                |                       | 2022-03-23              | Go To SEC.gov - https://www.sec.gov | ui-98-po                  |                                  |
      | Administrative Proceeding3 | Administrative Proceedings | AAER-34567           | David             | this is David detail    | published        | 2021-04-04 12:00:00 | 1      |                       |                                |                       | 2022-03-23              | Go To SEC.gov - https://www.sec.gov | ui-98-po                  | 1                                |
