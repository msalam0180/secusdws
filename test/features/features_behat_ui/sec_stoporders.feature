...
Scenario: Stop Orders Pages Screenshot
  Given "rulemaking_index" terms:
    ...
    And "release" content:
      ...
      | Test  | Stop Orders        | Note                  | 2-12312, 1-32, 4-523 | published        | 2021-02-02 12:00:00 | 1      | Frank             | Behat External, Behat Internal | Comment behat         | ui-98-po, ab-12-cd        |                                  |
      | Test2 | Stop Orders        | Note                  | 2-12312, 1-32, 4-523 | published        | 2021-02-02 12:00:00 | 1      | Frank             | Behat External, Behat Internal | Comment behat         | ui-98-po, ab-12-cd        | 1                                |
