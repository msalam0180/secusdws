...
class Helper {
   ...
   */
  async waitTimeOut(arg1) {
    arg1 = arg1 * 1000;
    await browser.executeAsync((arg1, done) => {
   ...
   * @returns {string} Returns file_name to help with file/folder structure.
   */
  async generateFileNameOnUrl(arg2) {
    var arg1 = await browser.getUrl();
    var file_name = '';
  ...
  async checkTheResult(arg1) {
    ...
    await expect(arg1.misMatchPercentage).toEqual(0);
  }
}
