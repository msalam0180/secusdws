...
As a sec.gov site visitor, I should be able to view National Security Echanges.
  ...
  Background:
    Given "rulemaking_index" terms:
      ...
      And "rule" content:
        | title               | field_display_title | field_file_number | body                             | field_related_rule                          | field_primary_division_office | moderation_state | status | field_sro_organization | field_show_comments_received | field_show_submit_comments | field_submit_comments | field_comments_received             | field_comments_date_format | field_comments_due_date | field_comments_notice |
        ...
        | Behat Parent Rule 5 | Behat Parent Rule 5 | bi-93-po          | This is a parent rule overview 5 | Behat Interpretive Rule 5                   | Behat-office 5                | published        | 1      | Behat-sro-1            |                              |                            |                       |                                     | text                       |                         | rebuttal              |
  ...
  @api @javascript
  Scenario: Validate Default Universal Page
    Given I am on "/rules/sro/sro1"
    ...
    Then I should see the heading "How to Submit Comments"
    When I visit "/rules/sro/sro1"
    Then I should see the heading "Behat-sro-1 Rulemaking"
      And I should see "We encourage the public to submit comments on the following filings during the comment period. For detailed instructions, please read How to Submit Comments. We strongly encourage you to send your comments electronically. They will be posted on this website."
      ...
      And I should see "Go to SEC.gov" in the "Behat Parent Rule 1" row
      And I should see "See Also - Behat file 1, Behat file 2" in the "Behat Parent Rule 1" row
      ...
      And I should see the text "Comments Due: rebuttal" in the "Behat Parent Rule 5" row
      And I should see the text "Displaying 1 - 4 of 4"
      And I should not see the text "Behat Parent Rule 2"

  @api @javascript
  Scenario: Validating Universal View Search Filters
    Given I am on "/rules/sro/sro1"
    When I fill in "Title" with "1"
      And I press "Apply"
    Then I should see "Behat Parent Rule 1"
      And I should see the text "01-11111"
      And I should see the text "04-44444"
      And I should see "Displaying 1 - 2 of 2"
    When I fill in "Title" with ""
      And I fill in "Release Number" with "3"
      And I press "Apply"
    Then I should see "Behat Parent Rule 3"
      And I should see "Jan 3, 2021"
      And I should see "Displaying 1 - 1 of 1"
    When I fill in "Release Number" with ""
      And I fill in "File Number" with "9"
      And I press "Apply"
    Then I should see "01-11111"
      And I should see "04-44444"
      And I should see "05-55555"
      And I should see "Displaying 1 - 3 of 3"
    When I fill in "File Number" with ""
      And I select "2020" from "year"
    Then I should see "04-44444"
      And I should see "05-55555"
      And I should see "Displaying 1 - 2 of 2"
    When I select "1" from "month"
    Then I should see "05-55555"
      And I should not see "04-44444"
      And I should see "Displaying 1 - 1 of 1"
    When I select "" from "month"
      And I select "" from "year"
      And I press "Apply"
    Then I should see the text "Displaying 1 - 4 of 4"

  @api @javascript
  Scenario: Validate Universal Page Sorting of SEC Date
    Given I am on "/rules/sro/sro1"
    Then "Jan 4, 2022" should precede "Jan 3, 2021" for the query "//*[@id='block-secgov-content']/div/div/table/tbody/tr[*]/td[2]"
  ...
  @api @javascript
  Scenario: Validate Universal Page Sorting of File Number
    Given I am on "/rules/sro/sro1"
    ...
    When I click "sort by File Number"
      And I wait 3 seconds
    Then "bi-93-po" should precede "bi-90-po" for the query "//*[@id='block-secgov-content']/div/div/table/tbody/tr[*]/td[3]"

  @api
  Scenario: Universal Pagination
    Given "rule" content:
        | title               | field_display_title  | field_file_number | body                             | field_related_rule                          | field_primary_division_office | moderation_state | status | field_sro_organization |
        ...
        | Behat Parent Rule 2 | Behat Parent Rule 8  | bi-91-po          | This is a parent rule overview 2 | Behat Draft Rule-Release 7                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 4 | Behat Parent Rule 10 | bi-92-po          | This is a parent rule overview 4 | Behat Final-Concept Rule 2                  | Behat-office 4                | published        | 0      | Behat-sro-1            |
        ...
        | Behat Parent Rule 6 | Behat Parent Rule 12 | bi-94-po          | This is a parent rule overview 6 | Behat Final Rule 6                          | Behat-office 6                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 2 | Behat Parent Rule 14 | bi-91-po          | This is a parent rule overview 2 | Behat Draft Rule-Release 7                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 4 | Behat Parent Rule 16 | bi-92-po          | This is a parent rule overview 4 | Behat Final-Concept Rule 2                  | Behat-office 4                | published        | 0      | Behat-sro-1            |
        ...
        | Behat Parent Rule 6 | Behat Parent Rule 18 | bi-94-po          | This is a parent rule overview 6 | Behat Final Rule 6                          | Behat-office 6                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 2 | Behat Parent Rule 20 | bi-91-po          | This is a parent rule overview 2 | Behat Draft Rule-Release 7                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 4 | Behat Parent Rule 22 | bi-92-po          | This is a parent rule overview 4 | Behat Final-Concept Rule 2                  | Behat-office 4                | published        | 0      | Behat-sro-1            |
        ...
        | Behat Parent Rule 6 | Behat Parent Rule 24 | bi-94-po          | This is a parent rule overview 6 | Behat Final Rule 6                          | Behat-office 6                | published        | 1      | Behat-sro-1            |
        ...
        | Behat Parent Rule 2 | Behat Parent Rule 26 | bi-91-po          | This is a parent rule overview 2 | Behat Interim Final Rule 3                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        | Behat Parent Rule 2 | Behat Parent Rule 27 | bi-91-po          | This is a parent rule overview 2 | Behat Interim Final Rule 3                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        | Behat Parent Rule 2 | Behat Parent Rule 28 | bi-91-po          | This is a parent rule overview 2 | Behat Interim Final Rule 3                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
        | Behat Parent Rule 2 | Behat Parent Rule 29 | bi-91-po          | This is a parent rule overview 2 | Behat Interim Final Rule 3                  | Behat-office 2                | published        | 1      | Behat-sro-1            |
    When I am on "/rules/sro/sro1"
    Then I should see the text "Displaying 1 - 25 of 28"
    ...
    Then I should see the text "Displaying 26 - 28 of 28"
    When I click "First"
    Then I should see the text "Displaying 1 - 25 of 28"
