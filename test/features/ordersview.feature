 ...
 Background:
    Given "rulemaking_index" terms:
      ...
      And "regulation" content:
        ...
        | Behat Proposed Rule 1      | detail body 1       | Other           | 01-11111             | 2022-01-04 12:00:00 | published        | 1      | behat file 1       | behat file 1, Behat file 2 |
        | Behat Final-Concept Rule 2 | detail body 2       | Other           | 02-22222             | 2021-07-01 12:00:00 | published        | 1      | behat file 2       | behat file 2               |
        | Behat Interim Final Rule 3 | detail body 3       | FASB            | 03-33333             | 2021-01-03 12:00:00 | published        | 1      | behat file 3       | behat file 3               |
  ...
  Scenario: Validate Default Other Commission Orders Page
    ...
    Then I should see the heading "Behat Parent Rule 1"
    When I am on "/rules/other"
      And I click "Submit A Comment"
