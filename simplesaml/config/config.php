...
/* Custom configurations to override variables in the file above.
 * Importing acquia configs based on Acquia Cloud implementation document.
 * @link https://docs.acquia.com/resource/simplesaml/
*/
if (file_exists('/var/www/site-php')) {
  require_once("/var/www/html/" . $_ENV['AH_SITE_NAME'] . "/simplesaml/config/acquia_config.php");
}
