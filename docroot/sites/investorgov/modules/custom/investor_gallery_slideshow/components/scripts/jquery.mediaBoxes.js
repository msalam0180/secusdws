            ...
            container.magnificPopup({
                ...
                callbacks           : {
                    change : function() {
                        ...
                        //CUSTOM HANDLING OF LIMELIGHT VIDEOS AND AUDIO
                        $("audio,video").each(function(){this.pause()});
                        if (window.LimelightPlayerUtil && window.LimelightPlayerUtil.players) {
                            for (player in window.LimelightPlayerUtil.players) {window.LimelightPlayerUtil.players[player].doSkin()}
                        }
                    ...
                    close: function () {
                        ...
                        //CUSTOM HANDLING OF LIMELIGHT VIDEOS AND AUDIO
                        if (window.LimelightPlayerUtil && window.LimelightPlayerUtil.players) {
                            for (player in window.LimelightPlayerUtil.players) {window.LimelightPlayerUtil.players[player].doPause()}
                        }
                        $("audio,video").each(function(){this.pause()});
                    },
                    ...
                    open: function(){
                        ...
                        //CUSTOM HANDLING OF LIMELIGHT VIDEOS
                        if (window.LimelightPlayerUtil && window.LimelightPlayerUtil.players) {
                            for (player in window.LimelightPlayerUtil.players) {window.LimelightPlayerUtil.players[player].doSkin()}
                        }
                    },
