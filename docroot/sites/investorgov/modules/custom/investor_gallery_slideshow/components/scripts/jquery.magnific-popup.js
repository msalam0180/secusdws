...
$.magnificPopup = {
	...
	defaults: {
		...
		closeMarkup: '<button title="%title%" type="button" class="mfp-close" aria-label="%title%"><span aria-hidden="true">&#215;</span></button>',
...
$.magnificPopup.registerModule('gallery', {
	...
	options: {
		enabled: false,
		arrowMarkup: '<button title="%title%" type="button" aria-label="%dir%" class="mfp-arrow mfp-arrow-%dir%"></button>',
		preload: [0,2],
