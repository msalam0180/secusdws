...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/secgov/investorgov-settings.inc';
}
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  // Force base_url for sitemap.xml on Acquia environments
  if ($_ENV['AH_SITE_ENVIRONMENT'] == 'prod') {
    $config['simple_sitemap.settings']['base_url'] = 'https://www.investor.gov';
  } else {
